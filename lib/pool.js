...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function OnBlockchainSynced(syncedCallback){
        ...
        var generateProgress = function(){
            ...
            var cmd = options.coin.hasGetInfo ? 'getinfo' : 'blocknotify';
    ...
    function DetectCoinData(finishedCallback){
        ...
        if (options.coin.hasGetInfo) {
            ...
            batchRpcCalls.push(['blocknotify', []], ['getnetworkinfo', []]);
        }
        _this.daemon.batchCmd(batchRpcCalls, function(error, results){
            ...
            options.testnet = options.coin.hasGetInfo ? rpcResults.getinfo.testnet : (rpcResults.blocknotify.chain === 'test') ? true : false;
            ...
            var difficulty = options.coin.hasGetInfo ? rpcResults.getinfo.difficulty : rpcResults.blocknotify.difficulty;
